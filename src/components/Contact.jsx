            ...
            <div className="grid grid-cols-1 md:grid-cols-2     ">
              ...
              <div className=" justify-center flex flex-col md:pl-6 pl-0   w-full items-start">
                <div className="flex uppercase w-full ">
                  <FaUser className="text-[#0A3981] md:text-lg lg:text-xl text-[10px]  leading-5 mr-3 h-5" />
                  <h2 className="md:text-lg lg:text-xl text-[10px]  leading-5  text-gray-500 mb-4">Ahmed Irfan</h2>
                </div>
                <div className="flex uppercase">
                  <FaLocationDot className="text-[#0A3981] md:text-lg lg:text-2xl text-sm mr-2 h-4" />
                  <h2 className="md:text-lg lg:text-xl text-[10px]  leading-5  text-gray-500  mb-4">Sekkalai Road,<br/>near FIVE LAMPS,Karaikudi,<br/>Tamil Nadu 630001</h2>
                </div>
                <div className="flex uppercase">
                  <BiPhoneIncoming className="text-[#0A3981] md:text-lg lg:text-2xl text-[10px]  leading-5 mr-3 h-5" />
                  <a href="tel:919751944100"><h2 className="md:text-lg lg:text-xl text-[10px]  leading-5  text-gray-500  mb-4">91+ 9751944100</h2></a>
                </div>
                <div className="flex uppercase">
                  <BiPhoneCall className="text-[#0A3981] md:text-lg lg:text-2xl text-[10px]  leading-5 mr-3 h-5" />
                  <a href="tel:04565-238474"><h2 className="md:text-lg lg:text-xl text-[10px]  leading-5  text-gray-500  mb-4">04565-238474</h2></a>
                </div>
                <div className="flex">
                  <MdVerifiedUser className="text-[#0A3981] md:text-lg lg:text-2xl text-[10px]  leading-5 mr-3 h-5" />
                  <h2 className="md:text-lg lg:text-xl text-[10px]  leading-5  text-gray-500  mb-4">33AAEPH3394N1ZH</h2>
                </div>
